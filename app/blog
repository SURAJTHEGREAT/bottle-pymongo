...
import pymongo
from app import blogPostDAO,sessionDAO,userDAO
import bottle
import cgi
import re
import os
...
# General Discussion on structure. This program implements a blog.
# This file is the best place to start to get
# to know the code. In this file, which is the controller,
# we define a bunch of HTTP routes that are handled
# by functions. The basic way that this magic occurs is through the
# decorator design pattern. Decorators
# allow you to modify a function, adding code to be executed before and after the function.
# As a side effect
